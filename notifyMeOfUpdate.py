...
#content checking for
check = "background-image: url(http://d2z36cvpuhg4bw.cloudfront.net/door.png);"

#BODY HAS 0 CHILD NODES

# while this is true (it is true by default),
while True:
    # set the url as VentureBeat,
    url = "http://kawsone.com/"
    ...
    numChildren = len(soup.find('body').findChildren())
